      ...
      <div className='mainBox'>
        ...
        <div className='searchBox'>
          <div className="inputBox">
            <select 
              name='searchCategory' className='category dragNo'
        ...
        <div className="partBox dragNo">
          ...
          >
            <option value="">적용 장비 종류 전체</option>
            {
              part.map((data, index) => (
        ...
        <div className='resetBtn dragNo' onClick={reset}>초기화</div>
